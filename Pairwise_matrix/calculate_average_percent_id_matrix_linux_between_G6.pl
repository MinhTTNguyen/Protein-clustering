...
mkdir "G6" || die "Unable to create directory <$!>\n";
chmod 0777, "G6";
...
my $filein="/home/mnguyen/Research/Lysozyme/GH25_all_15Dec2017/Fungi/12June2018/temp_matrix_between_clusters/G6.fasta";
my $fileout="/home/mnguyen/Research/Lysozyme/GH25_all_15Dec2017/Fungi/12June2018/temp_matrix_between_clusters/G6_matrix.txt";
#$fileout=$fileout."_percent_id_matrix_between.txt";
...
sub Pairwise_id
{
	...
	my $seqIO_obj = Bio::SeqIO -> new(-file => ">G6\/G6.fasta", -format => 'fasta');
	$seqIO_obj->write_seq($seq_obj1);
	$seqIO_obj->write_seq($seq_obj2);

	my @params = ('matrix' => 'BLOSUM', 'type' => 'protein', 'outfile' => "G6\/MSA_G6.fasta", 'output' => 'fasta');
	my $factory = Bio::Tools::Run::Alignment::Clustalw->new(@params);
	my $simple_aln_obj = $factory-> align("G6\/G6.fasta", -format => 'fasta');
	my $pairwise_percent_identity=$simple_aln_obj->overall_percentage_identity;

	unlink("G6/MSA_G6.fasta");
	unlink("G6/G6.fasta");
