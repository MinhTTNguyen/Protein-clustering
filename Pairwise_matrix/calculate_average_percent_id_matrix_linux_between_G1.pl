...
mkdir "G1" || die "Unable to create directory <$!>\n";
chmod 0777, "G1";
...
my $filein="/home/mnguyen/Research/Lysozyme/GH25_all_15Dec2017/Fungi/12June2018/temp_matrix_between_clusters/G1.fasta";
my $fileout="/home/mnguyen/Research/Lysozyme/GH25_all_15Dec2017/Fungi/12June2018/temp_matrix_between_clusters/G1_matrix.txt";
...
sub Pairwise_id
{
	...
	my $seqIO_obj = Bio::SeqIO -> new(-file => ">G1\/G1.fasta", -format => 'fasta');
	$seqIO_obj->write_seq($seq_obj1);
	$seqIO_obj->write_seq($seq_obj2);

	my @params = ('matrix' => 'BLOSUM', 'type' => 'protein', 'outfile' => "G1\/MSA_G1.fasta", 'output' => 'fasta');
	my $factory = Bio::Tools::Run::Alignment::Clustalw->new(@params);
	my $simple_aln_obj = $factory-> align("G1\/G1.fasta", -format => 'fasta');
	my $pairwise_percent_identity=$simple_aln_obj->overall_percentage_identity;

	unlink("G1/MSA_G1.fasta");
	unlink("G1/G1.fasta");
